...
- **Data-Driven / AI-Enabled Features:** Integrated external APIs (Open-Meteo) to fetch real-time weather data and calculate dynamic, logic-based layering recommendations.
- **Version Control:** Git 
